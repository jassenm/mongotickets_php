...
#$param = array( websiteConfigID => "$clientID", parentCategoryID => "2");
$param = array( websiteConfigID => $clientID, parentCategoryID => 1, childCategoryID => 63, grandchildCategoryID => 16, hasEvent => "false");
...
if ($soapclient->getError())
{
	...
	die ('ImportPerformersByCatFromTND.php exiting');
}
else {
