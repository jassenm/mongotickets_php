...
$date="";
   $result = mysql_query('SELECT EventName,Events.EventID,CategoryID FROM Events INNER JOIN Productions ON (Events.EventID = Productions.EventID) WHERE CategoryID='.$catID . ' GROUP BY EventID');
