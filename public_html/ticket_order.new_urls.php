...
echo "<div><h2 style='text-align: center; font-size:16px; margin: 0; padding: 4px 0px 0px 0px;'><strong>$eventName</strong><br />$eventDate, $venueName</h2></div>";

echo "   <div style='overflow: hidden; margin: -70 0 0 -5px; padding: 0 0 0 21px; '>";
echo "		 <iframe style='overflow: hidden; padding: 0 0 0 0; margin: 0 0 0 0px; z-index: -1;' scrolling=auto frameborder=0 src=\"https://www.ticketsnow.com/buytickets.aspx?id=$ticketID&reqqty=$quantity&client=4089\" height=\"1370\" width=\"100%\"></iframe>";
#echo "</div>";
